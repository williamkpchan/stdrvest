...
setwd("C:/Users/User/Pictures/sexpage/sexhd")

library(rvest)
library(crayon)
 ligSilver <- make_style("#889988")
# https://www.sexhd.pics/
# https://www.sexhd.pics/popular/sites
# https://www.sexhd.pics/popular/models
# https://www.sexhd.pics/popular/tags
# select end to get last page
# <a href="/gallery/xlgirls/mahogany-masters/lovely-bbw-oiledhdxxx/"><img src="//vip.sexhd.pics/media/xlgirls/mahogany-masters/lovely-bbw-oiledhdxxx/hd-mahogany-masters-16.jpg" alt="Xlgirls Mahogany Masters Lovely Bbw Oiledhdxxx"><p>Mahogany Masters<br>Xlgirls</p></a>
# className = "a"
# filter <a href="/gallery/
# 
urlHeader = "https://www.sexhd.pics/popular/sites/"
totalPages = 1368
linkClassName = "a"
wholePage = character()
outFile = "sitesAllLinks.txt"
