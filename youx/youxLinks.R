...
pageHeader = "https://www.youx.xxx/tag/mature/"
pageTail=""

wholePage = character()
theFilenameHead = "youxLinks"
...
#https://www.youx.xxx/hit/3175812/0/?url=https%253A%252F%252Fwww.twpornstars.com%252Fp%252F53470589&tag=mature
 ...
 itemList = gsub("^.*?url=","'",itemList)
 itemList = gsub("&.*data-src=", '><img src=',itemList)
 itemList = gsub("%252F", "/",itemList)
 itemList = gsub("%253A", ":",itemList)

 itemList = gsub(' data-srcset.*?alt="', ">",itemList)
