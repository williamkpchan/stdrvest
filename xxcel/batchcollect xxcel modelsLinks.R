...
setwd("C:/Users/User/Pictures/sexpage/xxcel")

library(rvest)
library(crayon)
 ligSilver <- make_style("#889988")

#https://xx-cel.com/photos/page-1
#https://xx-cel.com/photos/page-34
#.model-cover a
#<img src="//media.xx-cel.com

urlHeader = "https://xx-cel.com/photos/page-"
pageTail = ""
totalPages = 34
linkClassName = ".model-cover a"
wholePage = character()
outFile = "xxcel.html"
...
addr = 1:totalPages
      for(i in 1:length(addr)){
       ...
       itemList = gsub('src="//media', 'src="https://media', itemList)
